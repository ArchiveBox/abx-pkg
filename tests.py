...
class TestBinProvider(unittest.TestCase):
    def test_python_env(self):
        ...
        self.assertEqual(
            str(python_bin.loaded_binprovider.INSTALLER_BINARY.abspath),
    ...
    def _assert_binary_override_lifecycle(
        ...
        with contextlib.ExitStack() as stack:
            ...
            self.assertEqual(
                ...
                tuple(binary.overrides[provider.name]["install_args"]),
            )
        ...
        try:
            ...
            if override_binary:
                ...
                override_install_args = tuple(
                    override_binary.overrides[base_provider.name]["install_args"],
                )
